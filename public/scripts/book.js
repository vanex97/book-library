...
// doAjaxQuery('GET', '/api/admin/books/' + pathname.substr(bookIdPosition), null, function(res) {
...
//     doAjaxQuery('GET', '/api/admin/books/' + id + '/order?email=' + email, null, function(res) {
...
$('.btnBookID').click(function (event) {
        ...
        $.ajax({
                ...
                data: JSON.stringify({'id': +pathname.substr(bookIdPosition)}),
